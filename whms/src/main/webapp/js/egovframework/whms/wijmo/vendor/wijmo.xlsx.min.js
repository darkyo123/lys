    ...
    !function(t) {
        ...
        var s = function() {
            ...
            s.loadAsync = function(t) {
                var s = new JSZip;
                return e.assert(null != s.loadAsync, "Please use JSZip 3.0 to load excel files asynchrounously."),
                this._loadImpl(s, t)
            }
            ,
            s.save = function(e) {
            ...
            s._loadImpl = function(e, t) {
                ...
                return n = n.then(function() {
                    ...
                    if (e)
                        return e.async("string").then(function(e) {
                            l._getTheme(e),
                            r.colorThemes = l._colorThemes
                        }).then(function() {
                            var e = o.resolve();
                            return e = l._getZipStyle(s, e, r),
                            e = l._getZipSharedString(s, e, r)
                        });
                    var t = o.resolve();
                    return t = l._getZipStyle(s, t, r),
                    t = l._getZipSharedString(s, t, r)
                }),
                n = n.then(function() {
                    ...
                    return s.folder("xl/tables").forEach(function(t, s) {
                        ...
                        e = e.then(function() {
                            return s.async("string").then(function(e) {
                                var t = l._getTable(e);
                                t.fileName = s.name.substring(s.name.lastIndexOf("/") + 1),
                                l._tables.push(t)
                            })
                        })
                    }),
                ...
                n = n.then(function() {
                    ...
                    if (e)
                        return e.async("uint8array").then(function(e) {
                ...
                (n = n.then(function() {
                        ...
                        if (t && -1 === t.indexOf("/")) {
                            ...
                            isNaN(n) || (e = e.then(function() {
                                return i.async("string").then(function(e) {
                                    if (l._getSheet(e, n - 1, r),
                                    null != r.sheets[n - 1].tableRIds || null != r.sheets[n - 1].hyperlinkRIds) {
                                        var t = s.file("xl/worksheets/_rels/sheet" + n + ".xml.rels");
                                        if (t)
                                            return t.async("string").then(function(e) {
                                                for (var t = e.split("<Relationship "), s = t.length; --s; ) {
                                                    var i = t[s]
                                                      , o = l._getAttr(i, "Id");
                                                    r.sheets[n - 1].tableRIds && -1 !== r.sheets[n - 1].tableRIds.indexOf(o) ? (null == r.sheets[n - 1].tables && (r.sheets[n - 1].tables = []),
                                                    r.sheets[n - 1].tables.push(l._getSheetRelatedTable(i))) : r.sheets[n - 1].hyperlinkRIds && l._getSheetRelatedHyperlink(i, o, r.sheets[n - 1])
                                                }
                                            })
                                    }
                                })
                    ...
                    return r.processTime = Date.now() - i,
                    s = null,
                    r
                })
            }
            ...
            s._saveWorkbookToZip = function(t, s) {
                ...
                Date.now();
                var l = new JSZip;
                s ? e.assert(null != l.generateAsync, "Please use JSZip 3.0 to save excel files asynchrounously.") : e.assert(null == l.generateAsync, "Please use JSZip 2.5 to save excel files synchronously."),
                l.folder("_rels").file(".rels", this._xmlDescription + this._generateRelsDoc());
                var i = l.folder("docProps")
                  , r = l.folder("xl");
                this._colorThemes = t.colorThemes,
                r.folder("theme").file("theme1.xml", this._xmlDescription + this._generateThemeDoc()),
                this._macroEnabled = !(!t.reservedContent || !t.reservedContent.macros),
                this._macroEnabled && r.file("vbaProject.bin", t.reservedContent.macros);
                var n = r.folder("worksheets");
                i.file("core.xml", this._xmlDescription + this._generateCoreDoc(t)),
                ...
                for (var o, a = t.sheets.length; a--; )
                    if (this._generateWorkSheet(a, t, n),
                    t.sheets[a] && (t.sheets[a].tables && t.sheets[a].tables.length > 0 || t.sheets[a].externalLinks && t.sheets[a].externalLinks.length > 0)) {
                        var h = 0
                          , u = '<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">';
                        if (t.sheets[a].externalLinks && t.sheets[a].externalLinks.length > 0 && (u += this._generateHyperlinkRel(t.sheets[a].externalLinks),
                        h = t.sheets[a].externalLinks.length),
                        t.sheets[a].tables && t.sheets[a].tables.length > 0) {
                            null == o && (o = r.folder("tables"));
                            for (var c = 0; c < t.sheets[a].tables.length; c++) {
                                var f = t.sheets[a].tables[c];
                                this._generateTable(f, o),
                                u += '<Relationship Target="../tables/' + f.fileName + '" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/table" Id="rId' + (c + 1 + h) + '"/>'
                            }
                        }
                        u += "</Relationships>",
                        n.folder("_rels").file("sheet" + (a + 1) + ".xml.rels", this._xmlDescription + u)
                    }
                r.file("styles.xml", this._xmlDescription + this._generateStyleDoc()),
                l.file("[Content_Types].xml", this._xmlDescription + this._generateContentTypesDoc()),
                i.file("app.xml", this._xmlDescription + this._generateAppDoc(t)),
                r.folder("_rels").file("workbook.xml.rels", this._xmlDescription + this._generateWorkbookRels());
                var d = this._xmlDescription + this._generateSharedStringsDoc();
                return this._sharedStrings = [[], 0],
                r.file("sharedStrings.xml", d),
                d = null,
                r.file("workbook.xml", this._xmlDescription + this._generateWorkbook(t)),
                l
            }
            ,
            s._getSharedString = function(e) {
                var s, l, i, r, n, o, a, h = e.split(/<si.*?>/g), u = h.length;
                for (this._sharedStrings = []; --u; )
                    for (s = 1,
                    r = !1,
                    h[u].search(/<r>/gi) > -1 ? (r = !0,
                    l = h[u].split(/<r>/g)) : (h[u] = h[u].substring(0, h[u].indexOf("</t>")),
                    l = h[u].split(/<t.*?>/g)); s < l.length; )
                        o = null,
                        r ? (-1 !== l[s].indexOf("<rPr>") && (o = this._getTextRunFont(l[s])),
                        (i = l[s].match(/(<t.*?>)(.*)/)) && 3 === i.length && null != i[2] && (a = i[2].substring(0, i[2].indexOf("</t>"))),
                        n = {
                            font: o,
                            text: t.Workbook._unescapeXML(a)
                        },
                        null == this._sharedStrings[u - 1] ? this._sharedStrings[u - 1] = [n] : this._sharedStrings[u - 1].push(n)) : this._sharedStrings[u - 1] = t.Workbook._unescapeXML(l[s]),
                        s++
            }
            ,
            s._getInlineString = function(e) {
                for (var t = e.split("<t>"), s = t.length, l = ""; --s; )
                    l += t[s].substring(0, t[s].indexOf("</t>"));
                return l
            }
            ,
            s._getCoreSetting = function(e, t) {
                var s, l;
                (l = e.indexOf("<dc:creator>")) >= 0 && (s = e.substr(l + 12),
                t.creator = s.substring(0, s.indexOf("</dc:creator>"))),
                (l = e.indexOf("<cp:lastModifiedBy>")) >= 0 && (s = e.substr(l + 19),
                t.lastModifiedBy = s.substring(0, s.indexOf("</cp:lastModifiedBy>"))),
                (l = e.indexOf('<dcterms:created xsi:type="dcterms:W3CDTF">')) >= 0 && (s = e.substr(l + 43),
                t.created = new Date(s.substring(0, s.indexOf("</dcterms:created>")))),
                (l = e.indexOf('<dcterms:modified xsi:type="dcterms:W3CDTF">')) >= 0 && (s = e.substr(l + 44),
                t.modified = new Date(s.substring(0, s.indexOf("</dcterms:modified>"))))
            }
            ,
            s._getWorkbook = function(e, t) {
                var s, l, i, r, n, o, a, h, u = e.substring(e.indexOf("<bookViews>"), e.indexOf("</bookViews>")), c = "", f = e.indexOf("<definedNames>");
                for (u && (c = this._getAttr(u, "activeTab")),
                t.activeWorksheet = +c,
                o = (n = e.split("<sheet ")).length; --o; )
                    a = this._getAttr(n[o], "name"),
                    h = "hidden" !== this._getAttr(n[o], "state"),
                    t.sheets.unshift({
                        name: a,
                        visible: h,
                        columns: [],
                ...
                if (f > -1)
                    for (t.definedNames = [],
                    o = (n = e.substring(f, e.indexOf("</definedNames>")).split("<definedName ")).length; --o; )
                        a = this._getAttr(n[o], "name"),
                        (l = n[o].match(/.*>.+(?=<\/definedName>)/)) && (l = l[0].replace(/(.*>)(.+)/, "$2"),
                        l = isNaN(+l) ? l : +l),
                        s = {
                            name: a,
                            value: l
                        },
                        "" !== (i = this._getAttr(n[o], "localSheetId")) && (r = t.sheets[+i]) && (s.sheetName = r.name),
                        t.definedNames.unshift(s)
            }
            ,
            s._getTheme = function(e) {
                ...
                for (var t = e.substring(e.indexOf("<a:accent1"), e.indexOf("</a:accent6>")).split("<a:accent"), s = t.length; --s; )
                    this._colorThemes[s + 3] = this._getAttr(t[s], "val")
            }
            ,
            s._getStyle = function(e) {
                var s, l, i, r, n, o = [], a = [], h = [], u = this._numFmts.slice();
                if (this._styles = [],
                (i = e.indexOf("<numFmts")) >= 0) {
                    var c = e.substring(i + 8, e.indexOf("</numFmts>")).split("<numFmt");
                    for (s = c.length; --s; )
                        l = c[s],
                        u[+this._getAttr(l, "numFmtId")] = this._getAttr(l, "formatCode")
                }
                if ((i = e.indexOf("<fonts")) >= 0) {
                    var f = e.substring(i, e.indexOf("</fonts>")).split("<font>");
                    for (s = f.length; --s; )
                        l = f[s],
                        r = this._getChildNodeValue(l, "sz"),
                        o[s - 1] = {
                            bold: l.indexOf("<b/>") >= 0,
                ...
                if ((i = e.indexOf("<cellXfs")) >= 0) {
                    ...
                    s = m.length;
                    for (var g, _, y, b, v, S; --s; )
                        l = m[s],
                        _ = (g = u[y = +this._getAttr(l, "numFmtId")]) ? /[hsmy\:]/i.test(g) ? "date" : g.indexOf("0") > -1 ? "number" : "@" === g ? "string" : "unknown" : "unknown",
                        b = (y = +this._getAttr(l, "fontId")) > 0 ? o[y] : null,
                        v = (y = +this._getAttr(l, "fillId")) > 1 ? a[y] : null,
                        S = (y = +this._getAttr(l, "borderId")) > 0 ? h[y] : null,
                        i = l.indexOf("<alignment"),
                        n = +this._getAttr(l, "quotePrefix"),
            ...
            s._getEdgeBorder = function(e, s) {
                var l, i, r, n, o = e.indexOf("<" + s), a = e.indexOf("</" + s + ">");
                if (o >= 0) {
                    i = e.substring(o),
                    i = a >= 0 ? i.substring(0, a) : i.substring(0, i.indexOf("/>"));
                    var h = this._getAttr(i, "style");
                    h && (r = t.Workbook._parseStringToBorderType(h),
                    n = this._getColor(i, !1),
                    r === t.BorderStyle.Thin && n && "#c6c6c6" === n.toLowerCase() || ((l = {}).style = r,
                    l.color = n))
                }
                return l
            }
            ...
            s._getSheet = function(s, l, i) {
                ...
                if (s.indexOf("<mergeCells") > -1)
                    for (var o = s.substring(s.indexOf("<mergeCells"), s.indexOf("</mergeCells>")).split("<mergeCell "), a = o.length; --a; )
                        2 === (r = this._getAttr(o[a], "ref").split(":")).length && n.unshift({
                ...
                if (h[0].indexOf("<dimension") >= 0) {
                    ...
                    c && (c = c.substr(c.indexOf(":") + 1),
                    u.maxCol = this._alphaNum(c.match(/[a-zA-Z]*/g)[0]) + 1,
                    u.maxRow = +c.match(/\d*/g).join(""))
                }
                ...
                if (f > -1) {
                    var d = s.substring(f, s.indexOf("</tableParts>")).split("<tablePart ")
                      , p = d.length;
                    for (u.tableRIds = []; --p; )
                        u.tableRIds.unshift(this._getAttr(d[p], "r:id"))
                }
                ...
                u.summaryBelow = "0" !== this._getAttr(h[0], "summaryBelow"),
                a = h.length,
                h.length <= 1 ? (u.maxCol = 20,
                u.maxRow = 200) : u.maxRow < a - 1 && (u.maxRow = a - 1);
                for (var _, y = null, b = null; --a; ) {
                    ...
                    if (h[a].substring(0, h[a].indexOf(">")).indexOf("hidden") > -1 && "1" === this._getAttr(h[a], "hidden") && (v.visible = !1),
                    "1" === this._getAttr(h[a], "customHeight")) {
                        var S = +this._getAttr(h[a].substring(0, h[a].indexOf(">")).replace("customHeight", ""), "ht");
                        v.height = 96 * S / 72
                    }
                    y = null,
                    b = null,
                    "1" === this._getAttr(h[a], "customFormat") && (y = (b = this._styles[+this._getAttr(h[a].substring(h[a].indexOf(" s=")), "s")] || {
                        type: "General",
                        formatCode: null
                    ...
                    v.groupLevel = w && "" !== w ? +w : NaN,
                    v.collapsed = "1" === this._getAttr(h[a], "collapsed");
                    var x = h[a].split("<c ")
                      , C = x.length;
                    for ((null == u.maxCol || u.maxCol < C - 1) && (u.maxCol = C - 1); --C; ) {
                        ...
                        var A = null
                          , O = null
                          , R = null;
                        k.indexOf("<f") > -1 && (k.indexOf("</f>") > -1 ? (A = k.match(/<f.*>.+(?=<\/f>)/)) && (A = A[0].replace(/(\<f.*>)(.+)/, "$2")) : (O = this._getAttr(k, "si")) && (R = this._getAttr(k, "r"),
                        A = this._getSharedFormula(O, R))),
                        null != A && (A = A.replace(/\[\#This Row\]\s*,\s*/gi, "@")),
                        "str" === T || "e" === T || z || (F = F ? +F : ""),
                        _ = this._alphaNum(this._getAttr(k, "r").match(/[a-zA-Z]*/g)[0]);
                        var D = null;
                        switch (T) {
                        case "s":
                            null != (F = this._sharedStrings[F]) && (e.isString(F) ? b && b.quotePrefix && "'" !== F[0] && (F = "'" + F) : (D = F.slice(),
                            F = this._getTextOfTextRuns(D)));
                            break;
                        case "b":
                            F = 1 === F;
                            break;
                        ...
                        e.isInt(F) ? y.format = y.format || "#,##0" : y.format = y.format || "#,##0.00"),
                        v.cells[_] = {
                            value: F,
                            textRuns: D,
                            isDate: "date" === T,
                ...
                h.length > 0 && h[0].indexOf("<cols>") > -1)
                    for (var W = (N = h[0].substring(h[0].indexOf("<cols>") + 6, h[0].indexOf("</cols>")).split("<col ")).length - 1; W > 0; W--) {
                        ...
                        for (b = null,
                        N[W].indexOf("style") > -1 && (b = this._styles[+this._getAttr(N[W], "style")] || {
                            type: "General",
                            formatCode: null
                        }),
                        y = null,
                        b && (b.font || b.fillColor || b.hAlign || b.vAlign || b.wordWrap || b.borders || b.formatCode && "General" !== b.formatCode) && (y = {
                            format: b.formatCode && "General" !== b.formatCode ? b.formatCode : null,
                            font: b.font,
                            fill: {
                                color: b.fillColor
                        ...
                        _ = +this._getAttr(N[W], "min") - 1; _ < +this._getAttr(N[W], "max") && _ < u.maxCol; _++)
                            B[_] = {
                ...
                if (P > -1)
                    for (var L = s.substring(P, s.indexOf("</hyperlinks>")).split("<hyperlink "), E = L.length; --E; )
                        this._getHyperlink(u, L[E]);
                if (u.frozenPane) {
                    if (!isNaN(u.frozenPane.rows))
                        for (a = 0; a < u.rows.length && a < u.frozenPane.rows; a++)
                            u.rows[a] && !u.rows[a].visible && u.frozenPane.rows++;
                    if (!isNaN(u.frozenPane.columns))
                        for (a = 0; a < B.length && a < u.frozenPane.columns; a++)
                            B[a] && !B[a].visible && u.frozenPane.columns++
                }
                var I;
                for (C = 0; C < n.length; C++)
                    I = n[C],
                    u.rows[I.topRow] || (u.rows[I.topRow] = {
                        cells: []
                    }),
                    u.rows[I.topRow].cells || (u.rows[I.topRow].cells = []),
                    u.rows[I.topRow].cells[I.leftCol] || (u.rows[I.topRow].cells[I.leftCol] = {}),
                    u.rows[I.topRow].cells[I.leftCol].rowSpan = I.bottomRow < u.maxRow ? I.bottomRow - I.topRow + 1 : 200,
                    u.rows[I.topRow].cells[I.leftCol].colSpan = I.rightCol < u.maxCol ? I.rightCol - I.leftCol + 1 : 20
            }
            ,
            s._getTable = function(e) {
                ...
                t.showBandedColumns = "1" === this._getAttr(i, "showColumnStripes"),
                t.showBandedRows = "1" === this._getAttr(i, "showRowStripes"),
                t.alterFirstColumn = "1" === this._getAttr(i, "showFirstColumn"),
                t.alterLastColumn = "1" === this._getAttr(i, "showLastColumn");
            ...
            s._getTableColumn = function(e) {
                ...
                if (s)
                    ...
                    "custom" === l && (l = e.substring(e.indexOf("<totalsRowFormula>") + 2 + "totalsRowFormula".length, e.indexOf("</totalsRowFormula>"))),
                    t.totalRowFunction = l
                }
                return t
            }
            ,
            ...
            s._getTableStyleElement = function(e) {
                ...
                return t = null,
                (r = e.indexOf("<fill>")) >= 0 && (t = e.substring(r, e.indexOf("</fill>")),
                l = {
                    color: this._getColor(t, !0)
                }),
                t = null,
                (r = e.indexOf("<border>")) >= 0 && (t = e.substring(r, e.indexOf("</border>")),
                i = {
            ...
            s._getTableStyleByName = function(e) {
                ...
                for (t = 0; t < this._tableStyles.length; t++)
                    if ((s = this._tableStyles[t]) && s.name.toLowerCase() === e.toLowerCase())
                        return s;
                return null
            }
            ,
            s._getHyperlink = function(e, s) {
                ...
                if (null != (l = this._getAttr(s, "ref"))) {
                    r = l.split(":"),
                    null == (o = this._getAttr(s, "r:id")) && (a = this._getAttr(s, "location"));
                    for (var h = 0; h < r.length; h++)
                        i = r[h],
                        n = t.Workbook.tableAddress(i),
                        o ? (null == e.hyperlinkRIds && (e.hyperlinkRIds = []),
            ...
            s._isBuiltInStyleName = function(e) {
                ...
                if (0 === e.search(/TableStyleLight/i)) {
                    ...
                    !isNaN(t) && t >= 1 && t <= 28)
                        return !0
                } else if (0 === e.search(/TableStyleDark/i) && (t = +e.substring(14),
                !isNaN(t) && t >= 1 && t <= 11))
                    return !0;
                return !1
            }
            ...
            s._generateClrScheme = function() {
                return null === this._colorThemes && (this._colorThemes = []),
            ...
            s._generateCoreDoc = function(e) {
                ...
                return e.creator ? t += "<dc:creator>" + e.creator + "</dc:creator>" : t += "<dc:creator/>",
                e.lastModifiedBy ? t += "<cp:lastModifiedBy>" + e.lastModifiedBy + "</cp:lastModifiedBy>" : t += "<cp:lastModifiedBy/>",
                t += '<dcterms:created xsi:type="dcterms:W3CDTF">' + (e.created || new Date).toISOString() + '</dcterms:created><dcterms:modified xsi:type="dcterms:W3CDTF">' + (e.modified || new Date).toISOString() + "</dcterms:modified></cp:coreProperties>"
            }
            ,
            s._generateSheetGlobalSetting = function(e, t, s) {
                ...
                i += '<dimension ref="A1' + (l > 0 ? ":" + this._numAlpha(l - 1) + t.rows.length : "") + '"/>',
                i += '<sheetViews><sheetView workbookViewId="0"',
                e === s.activeWorksheet && (i += ' tabSelected="1"'),
                !t.frozenPane || 0 === t.frozenPane.rows && 0 === t.frozenPane.columns ? i += "/>" : (i += ">",
                i += '<pane state="frozen" activePane="' + (0 !== t.frozenPane.rows && 0 !== t.frozenPane.columns ? "bottomRight" : 0 !== t.frozenPane.rows ? "bottomLeft" : "topRight") + '" topLeftCell="' + (this._numAlpha(t.frozenPane.columns) + (t.frozenPane.rows + 1)) + '" ySplit="' + t.frozenPane.rows.toString() + '" xSplit="' + t.frozenPane.columns.toString() + '"/>',
                i += "</sheetView>"),
                i += "</sheetViews>",
                i += '<sheetFormatPr defaultRowHeight="15" x14ac:dyDescent="0.25"/>'
            }
            ,
            s._generateCell = function(e, s, l, i, r, n) {
                ...
                i && (o += ' t="' + i + '"');
                var a = "";
                return n && ("=" === n[0] && (n = n.substring(1)),
                n = n.replace(/\@\s*/gi, "[#This Row], "),
                a += "<f>" + t.Workbook._escapeXML(n) + "</f>"),
                null != r && "" !== r && (a += "<v>" + r + "</v>"),
                o + (a ? ">" + a + "</c>" : "/>")
            }
            ,
            s._generateMergeSetting = function(e) {
                for (var t = '<mergeCells count="' + e.length.toString() + '">', s = 0; s < e.length; s++)
                    t += '<mergeCell ref="' + e[s].join(":") + '"/>';
                return t + "</mergeCells>"
            }
            ,
            s._generateStyleDoc = function() {
                ...
                for (d += this._generateCellXfs(0, 0, 0, 0, {}); i < this._styles.length; ) {
                    ...
                    if (p) {
                        ...
                        if ((p = JSON.parse(p)).format && "General" !== p.format && (m = this._numFmts.indexOf(p.format)) < 0) {
                            var g = l.indexOf(p.format);
                            -1 === g ? (l.push(p.format),
                            s += '<numFmt numFmtId="' + (m = 164 + r).toString() + '" formatCode="' + p.format + '"/>',
                            r++) : m = 164 + g
                        }
                        var _ = 0;
                        if (p.borders) {
                            var y = JSON.stringify(p.borders);
                            (_ = this._borders.indexOf(y)) < 0 && (_ = this._borders.push(y) - 1,
                            c += this._generateBorderStyle(p.borders))
                        }
                        var b = 0;
                        if (p.font) {
                            var v = JSON.stringify(p.font);
                            (b = this._fonts.indexOf(v)) < 0 && (b = this._fonts.push(v) - 1,
                            o += this._generateFontStyle(p.font))
                        }
                        var S = 0;
                        if (p.fill && p.fill.color) {
                            var w = JSON.stringify(p.fill);
                            (S = this._fills.indexOf(w)) < 0 && (S = this._fills.push(w) - 1,
                            h += this._generateFillStyle("solid", p.fill.color))
                        }
                ...
                l = null,
                r > 0 ? (t = '<numFmts count="' + r + '">',
                t += s,
                t += "</numFmts>") : t = '<numFmts count="0"/>',
                e += t,
                n = '<fonts count="' + this._fonts.length + '" x14ac:knownFonts="1">',
                n += o,
                e += n += "</fonts>",
                a = '<fills count="' + this._fills.length + '">',
                a += h,
                e += a += "</fills>",
                u = '<borders count="' + this._borders.length + '">',
                u += c,
                e += u += "</borders>",
                ...
                var x = ""
                  , C = "";
                return this._tableStyles.length > 0 && (this._getDxfs(),
                this._dxfs.length > 0 && (x = this._generateDxfs()),
                C = this._generateTableStyles()),
                e += f + '<cellStyles count="1"><cellStyle xfId="0" builtinId="0" name="Normal"/></cellStyles>' + ("" === x ? '<dxfs count="0"/>' : x) + ("" === C ? '<tableStyles count="0" defaultTableStyle="TableStyleMedium9" defaultPivotStyle="PivotStyleLight16"/>' : C) + '<extLst><ext uri="{EB79DEF2-80B8-43e5-95BD-54CBDDF9020C}"><x14ac:slicerStyles defaultSlicerStyle="SlicerStyleLight1" xmlns:x14="http://schemas.microsoft.com/office/spreadsheetml/2009/9/main"/></ext></extLst></styleSheet>'
            }
            ,
            s._generateBorderStyle = function(e, t) {
                ...
                for (var r in {
                    ...
                    (t || "vertical" !== r && "horizontal" !== r) && (e[r] ? (s = "<" + r + ' style="' + e[r].style + '">',
                    "",
                    6 === (l = (l = e[r].color) ? "#" === l[0] ? l.substring(1) : l : "").length && (l = "FF" + l),
                    l || (l = "FF000000"),
                    s += '<color rgb="' + l + '"/>',
                    s += "</" + r + ">") : s = "<" + r + "/>",
                    i += s);
            ...
            s._generateFontStyle = function(e, t) {
                ...
                e.italic && (s += "<i/>"),
                e.underline && (s += "<u/>"),
                s += '<sz val="' + (e.size ? Math.round(72 * e.size / 96) : this._defaultFontSize) + '"/>',
                e.color ? s += '<color rgb="FF' + ("#" === e.color[0] ? e.color.substring(1) : e.color) + '"/>' : s += '<color theme="1"/>',
                s += '<name val="' + (e.family || this._defaultFontName) + '"/>',
                s += '<family val="2"/>',
                t && (s += '<scheme val="minor"/>'),
                s += "</font>"
            }
            ,
            s._generateFillStyle = function(e, t, s) {
                ...
                return t && (l = s ? "<bgColor " : "<fgColor ",
                i += l += 'rgb="FF' + ("#" === t[0] ? t.substring(1) : t) + '"/>'),
                i += "</patternFill></fill>"
            }
            ,
            s._generateCellXfs = function(e, t, s, l, i) {
                var r = '<xf xfId="0" ';
                if (r += 'numFmtId="' + e.toString() + '" ',
                ...
                r += 'fillId="' + l.toString() + '" ',
                l > 0 && (r += 'applyFill="1" '),
                i.quotePrefix && (r += 'quotePrefix="1" '),
                i.hAlign || i.vAlign || i.indent || i.wordWrap) {
                    r += 'applyAlignment="1">';
                    var n = "<alignment ";
                    i.hAlign && (n += 'horizontal="' + i.hAlign + '" '),
                    i.vAlign && (n += 'vertical="' + i.vAlign + '" '),
                    i.indent && (n += 'indent="' + i.indent + '" '),
                    i.wordWrap && (n += 'wrapText="1"'),
                    r += n += "/>",
                    r += "</xf>"
                } else
                    r += "/>";
            ...
            s._generateContentTypesDoc = function() {
                ...
                for (this._macroEnabled && (t += '<Default ContentType="application/vnd.ms-office.vbaProject" Extension="bin"/>'),
                ...
                e = 0; e < this._contentTypes.length; e++)
                ...
                e = 0; e < this._tables.length; e++)
                    t += '<Override ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.table+xml" PartName="/xl/tables/' + this._tables[e] + '"/>';
                return t += "</Types>"
            }
            ,
            s._generateAppDoc = function(e) {
                for (var t = '<Properties xmlns:vt="http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes" xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties"><Application>' + (e.application || "wijmo.xlsx") + '</Application><DocSecurity>0</DocSecurity><ScaleCrop>false</ScaleCrop><HeadingPairs><vt:vector baseType="variant" size="2"><vt:variant><vt:lpstr>Worksheets</vt:lpstr></vt:variant><vt:variant><vt:i4>' + this._props.length + '</vt:i4></vt:variant></vt:vector></HeadingPairs><TitlesOfParts><vt:vector baseType="lpstr" size="' + this._props.length + '">', s = 0; s < this._props.length; s++)
                    t += "<vt:lpstr>" + this._props[s] + "</vt:lpstr>";
            ...
            s._generateWorkbook = function(e) {
                for (var t = '<workbook xmlns="' + this._workbookNS + '" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships"><fileVersion rupBuild="9303" lowestEdited="5" lastEdited="5" appName="xl"/><workbookPr/><bookViews><workbookView xWindow="480" yWindow="60" windowWidth="18195" windowHeight="8505"' + (null != e.activeWorksheet ? ' activeTab="' + e.activeWorksheet.toString() + '"' : "") + "/></bookViews><sheets>", s = 0; s < this._worksheets.length; s++)
                    t += this._worksheets[s];
                if (t += "</sheets>",
                e.definedNames && e.definedNames.length > 0) {
                    for (t += "<definedNames>",
                    s = 0; s < e.definedNames.length; s++) {
                        var l = -1;
                        e.definedNames[s].sheetName && (l = this._getSheetIndexBySheetName(e, e.definedNames[s].sheetName)),
                        t += '<definedName name="' + e.definedNames[s].name + '" ' + (l > -1 ? 'localSheetId="' + l + '"' : "") + ">" + e.definedNames[s].value + "</definedName>"
                    }
                    t += "</definedNames>"
                }
            ...
            s._generateWorkSheet = function(s, l, i) {
                ...
                var O = "<sheetData>";
                for (h = n.style ? this._cloneStyle(n.style) : null,
                "",
                [],
                c = [],
                f = -1,
                d = (u = n.rows) ? u.length : 0; ++f < d; ) {
                    for (p = -1,
                    m = u[f] && u[f].cells ? u[f].cells.length : 0,
                    g = null,
                    O += '<row x14ac:dyDescent="0.25" r="' + (f + 1).toString() + '"',
                    u[f] && (u[f].height && (O += ' customHeight="1" ht="' + (72 * +u[f].height / 96).toString() + '"'),
                    u[f].groupLevel && (O += ' outlineLevel="' + u[f].groupLevel.toString() + '"'),
                    (g = u[f].style ? this._cloneStyle(u[f].style) : null) && ((g = this._resolveStyleInheritance(g)).font && g.font.color && (g.font.color = this._parseColor(g.font.color)),
                    g.fill && g.fill.color && (g.fill.color = this._parseColor(g.fill.color)),
                    null == g.hAlign || e.isString(g.hAlign) || (g.hAlign = t.Workbook._parseHAlignToString(e.asEnum(g.hAlign, t.HAlign))),
                    null == g.vAlign || e.isString(g.vAlign) || (g.vAlign = t.Workbook._parseVAlignToString(e.asEnum(g.vAlign, t.VAlign))),
                    _ = JSON.stringify(g),
                    (y = this._styles.indexOf(_)) < 0 && (y = this._styles.push(_) - 1),
                    O += ' customFormat="1" s="' + y.toString() + '"')),
                    u[f] && !1 === u[f].visible && (O += ' hidden="1"'),
                    u[f] && !0 === u[f].collapsed && (O += ' collapsed="1"'),
                    O += ">"; ++p < m; ) {
                        if (b = u[f].cells[p],
                        v = null,
                        S = null,
                        ...
                        x = -1,
                        F = b ? b.textRuns : null,
                        v = b && b.hasOwnProperty("value") ? b.value : b,
                        S = b && b.style ? this._cloneStyle(b.style) : {},
                        S = this._resolveStyleInheritance(S),
                        (C = a[p]) && (C = this._resolveStyleInheritance(C),
                        S = this._extend(S, C)),
                        g && (S = this._extend(S, g)),
                        h && (h = this._resolveStyleInheritance(h),
                        S = this._extend(S, h)),
                        null == S.hAlign || e.isString(S.hAlign) || (S.hAlign = t.Workbook._parseHAlignToString(e.asEnum(S.hAlign, t.HAlign))),
                        null == S.vAlign || e.isString(S.vAlign) || (S.vAlign = t.Workbook._parseVAlignToString(e.asEnum(S.vAlign, t.VAlign))),
                        S.font && S.font.color && (S.font.color = this._parseColor(S.font.color)),
                        S.fill && S.fill.color && (S.fill.color = this._parseColor(S.fill.color)),
                        this._applyDefaultBorder(S),
                        S.borders && (S.borders = this._extend({}, S.borders),
                        this._parseBorder(S.borders, !!S.fill && !!S.fill.color)),
                        b && b.isDate && !e.isDate(v)) {
                            var R = new Date(v);
                            e.isDate(R) && (v = R)
                        }
                        !e.isNumber(v) || !isNaN(v) && isFinite(v) || (v = v.toString()),
                        F || v && e.isString(v) && ("@" === S.format || "General" === S.format || (+v).toString() !== v || !isFinite(+v)) ? (this._sharedStrings[1]++,
                        "'" === (v = F ? "{RichTextMark}" + JSON.stringify(F) : t.Workbook._unescapeXML(v))[0] && (S.quotePrefix = !0,
                        v = v.substring(1)),
                        (x = this._sharedStrings[0].indexOf(v)) < 0 && (x = this._sharedStrings[0].push(v) - 1),
                        v = x,
                        w = "s") : e.isBoolean(v) ? (v = v ? 1 : 0,
                        w = "b") : e.isDate(v) ? (v = this._convertDate(v),
                        S.format = S.format || "mm-dd-yy") : e.isObject(v) && (v = null),
                        S = JSON.stringify(S),
                        (y = this._styles.indexOf(S)) < 0 && (y = this._styles.push(S) - 1),
                        b && (null != b.colSpan && b.colSpan > 1 || null != b.rowSpan && b.rowSpan > 1) && (b.colSpan = b.colSpan || 1,
                        b.rowSpan = b.rowSpan || 1,
                        this._checkValidMergeCell(c, f, b.rowSpan, p, b.colSpan) && c.push([this._numAlpha(p) + (f + 1), this._numAlpha(p + b.colSpan - 1) + (f + b.rowSpan)])),
                        b && b.link && (null == T && (T = []),
                        T.push({
                        ...
                        S = null,
                        O += this._generateCell(f, p, y, w, v, b && b.formula ? b.formula : null)
                    }
                    O += "</row>"
                }
                if (O += "</sheetData>",
                o && o.length > 0) {
                    ...
                    f = 0; f < o.length; f++)
                        if (y = -1,
                        this._isEmpty(a[f]) || (C = a[f]) && ((C = this._resolveStyleInheritance(C)).font && C.font.color && (C.font.color = this._parseColor(C.font.color)),
                        C.fill && C.fill.color && (C.fill.color = this._parseColor(C.fill.color)),
                        null == C.hAlign || e.isString(C.hAlign) || (C.hAlign = t.Workbook._parseHAlignToString(e.asEnum(C.hAlign, t.HAlign))),
                        null == C.vAlign || e.isString(C.vAlign) || (C.vAlign = t.Workbook._parseVAlignToString(e.asEnum(C.vAlign, t.VAlign))),
                        C = JSON.stringify(C),
                        (y = this._styles.indexOf(C)) < 0 && (y = this._styles.push(C) - 1)),
                        !this._isEmpty(o[f])) {
                            ...
                            var D = (f + 1).toString();
                            A += '<col min="' + D + '" max="' + D + '"',
                            y >= 0 && (A += ' style="' + y.toString() + '"'),
                            k && (A += ' width="' + k + '" customWidth="1"'),
                            !1 !== o[f].autoWidth && (A += ' bestFit="1"'),
                            !1 === o[f].visible && (A += ' hidden="1"'),
                            A += "/>"
                        }
                    A += "</cols>"
                }
                ...
                A = O,
                O = null,
                c.length > 0 && (A += this._generateMergeSetting(c)),
                T && T.length > 0) {
                    for (A += "<hyperlinks>",
                    f = 0; f < T.length; f++)
                        /\'?(\w+)\'?\!\$?[A-Za-z]{1,2}\$?\d+(:\$?[A-Za-z]{1,2}\$?\d+)?/.test(T[f].href) || /^\$?[A-Za-z]{1,2}\$?\d+(:\$?[A-Za-z]{1,2}\$?\d+)?$/.test(T[f].href) ? A += '<hyperlink ref="' + T[f].ref + '" display="' + T[f].value + '" location="' + T[f].href + '"/>' : (null == n.externalLinks && (n.externalLinks = []),
                        n.externalLinks.push(T[f].href),
                        A += '<hyperlink ref="' + T[f].ref + '" r:id="rId' + z + '"/>',
                        z++);
                    A += "</hyperlinks>"
                }
                if (A += '<pageMargins left="0.7" right="0.7" top="0.75" bottom="0.75" header="0.3" footer="0.3"/>',
                n.tables && n.tables.length > 0) {
                    for (A += '<tableParts count="' + n.tables.length + '">',
                    f = 0; f < n.tables.length; f++)
                        A += '<tablePart r:id="rId' + z + '"/>',
                        z++;
                    A += "</tableParts>"
                }
                A += "</worksheet>",
                i.file("sheet" + r + ".xml", this._xmlDescription + A),
                A = null;
                ...
                this._contentTypes.unshift(N),
                this._props.unshift(t.Workbook._escapeXML(n.name) || "Sheet" + r);
                        ...
                        try {
                            ...
                            if (l && l.length > 0) {
                                for (var i = 0; i < l.length; i++) {
                                    t += "<r>";
                                    var r = l[i];
                                    r.font && (t += this._generateFontStyle(r.font, !0).replace(/font/g, "rPr")),
            ...
            s._generatePlainText = function(s) {
                var l = "<t";
                return (e.isNullOrWhiteSpace(s) || /^\s+\w*|\w*\s+$/.test(s)) && (l += ' xml:space="preserve"'),
                l += ">" + t.Workbook._escapeXML(s) + "</t>"
            }
            ,
            s._generateTable = function(e, t) {
                ...
                !1 !== e.showHeaderRow && (i += this._generateTableFilterSetting(e.range, e.showTotalRow, e.columns)),
                i += '<tableColumns count="' + e.columns.length + '">';
                for (var r = "", n = 0; n < e.columns.length; n++) {
                    var o = e.columns[n];
                    r += '<tableColumn name="' + o.name + '" id="' + (n + 1) + '" ',
                    o.totalRowFunction ? this._tableColumnFunctions.indexOf(o.totalRowFunction) > -1 ? r += 'totalsRowFunction="' + o.totalRowFunction + '"/>' : r += 'totalsRowFunction="custom"><totalsRowFormula>' + o.totalRowFunction + "</totalsRowFormula></tableColumn>" : r += (o.totalRowLabel ? 'totalsRowLabel="' + o.totalRowLabel + '"' : "") + "/>"
                }
                if (i += r + "</tableColumns>",
                i += '<tableStyleInfo name="' + e.style.name + '" showColumnStripes="' + (e.showBandedColumns ? "1" : "0") + '" showRowStripes="' + (e.showBandedRows ? "1" : "0") + '" showLastColumn="' + (e.alterLastColumn ? "1" : "0") + '" showFirstColumn="' + (e.alterFirstColumn ? "1" : "0") + '"/></table>',
                !this._isBuiltInStyleName(e.style.name)) {
                    var a = JSON.stringify(e.style);
                    -1 === this._tableStyles.indexOf(a) && this._tableStyles.push(a)
                }
                t.file(l, this._xmlDescription + i),
                i = null
            }
            ,
            s._generateTableFilterSetting = function(e, s, l) {
                ...
                if (s) {
                    ...
                    n.row -= 1,
                    i = i.substring(0, r) + t.Workbook.xlsxAddress(n.row, n.col)
                }
                for (var o = '<autoFilter ref="' + i + '"', a = "", h = 0; h < l.length; h++)
                    !1 === l[h].showFilterButton && (a += '<filterColumn hiddenButton="1" colId="' + h + '"/>');
                return o += "" === a ? "/>" : ">" + a + "</autoFilter>"
            }
            ,
            s._generateHyperlinkRel = function(e) {
                for (var t = "", s = 0; s < e.length; s++)
                    t += '<Relationship TargetMode="External" Target="' + e[s] + '" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/hyperlink" Id="rId' + (s + 1) + '"/>';
                return t
            }
            ,
            s._getDxfs = function() {
                for (var t, s = this, l = 0; l < this._tableStyles.length; l++)
                    t = JSON.parse(this._tableStyles[l]),
                    Object.keys(t).forEach(function(l) {
                        var i, r, n = t[l];
                        n && !e.isString(n) && (s._isEmptyStyleEle(n) || (i = JSON.stringify(n),
                        -1 === (r = s._dxfs.indexOf(i)) && (r = s._dxfs.push(i) - 1,
                        n.styleIndex = r)))
                    }),
            ...
            s._generateDxfs = function() {
                for (var e, t = '<dxfs count="' + this._dxfs.length + '">', s = 0; s < this._dxfs.length; s++)
                    t += "<dxf>",
                    (e = JSON.parse(this._dxfs[s])).font && (t += this._generateFontStyle(e.font)),
                    e.fill && e.fill.color && (t += this._generateFillStyle("solid", e.fill.color, !0)),
                    e.borders && !this._isEmpty(e.borders) && (e.borders = this._extend({}, e.borders),
                ...
                for (var t, s, l, i, r, n, o = '<tableStyles count="' + this._tableStyles.length + '" defaultTableStyle="TableStyleMedium9" defaultPivotStyle="PivotStyleLight16">', a = 0; a < this._tableStyles.length; a++) {
                    ...
                    for (var h = 0; h < s.length; h++)
                        ...
                        !e.isString(i)) {
                            switch (n++,
                            r += "<tableStyleElement",
                            null != i.styleIndex && (r += ' dxfId="' + i.styleIndex + '"'),
                            l) {
                            case "firstBandedColumnStyle":
                                r += ' type="firstColumnStripe"',
                                null != i.size && (r += ' size="' + i.size + '"');
                                break;
                            case "secondBandedColumnStyle":
                                r += ' type="secondColumnStripe"',
                                null != i.size && (r += ' size="' + i.size + '"');
                                break;
                            case "firstBandedRowStyle":
                                r += ' type="firstRowStripe"',
                                null != i.size && (r += ' size="' + i.size + '"');
                                break;
                            case "secondBandedRowStyle":
                                r += ' type="secondRowStripe"',
                                null != i.size && (r += ' size="' + i.size + '"');
                                break;
                            default:
                    ...
                    n > 0 && (o += '<tableStyle count="' + n + '" name="' + t.name + '" pivot="0">',
                    o += r + "</tableStyle>")
                }
            ...
            s._getColor = function(e, t) {
                var s, l, i, r, n;
                return -1 === e.search(/fgcolor/i) && -1 === e.search(/bgcolor/i) && t || -1 === e.search(/color/i) && !t ? null : (-1 === (s = e.indexOf("<fgColor")) && (s = e.indexOf("<bgColor")),
                -1 !== (e = t ? e.substring(s, e.indexOf("/>")) : e.substring(e.indexOf("<color"))).indexOf("rgb=") ? (r = this._getAttr(e, "rgb")) && 8 === r.length && (r = r.substring(2)) : -1 !== e.indexOf("indexed") ? (i = +this._getAttr(e, "indexed"),
                r = this._indexedColors[i] || "") : (l = +this._getAttr(e, "theme"),
                -1 !== e.indexOf("tint") && (n = +this._getAttr(e, "tint")),
                r = this._getThemeColor(l, n)),
                r && "#" === r[0] ? r : "#" + r)
            }
            ,
            s._getThemeColor = function(t, s) {
                var l, i, r = this._colorThemes[t];
                return null != s ? (l = new e.Color("#" + r),
                i = l.getHsl(),
                i[2] = s < 0 ? i[2] * (1 + s) : i[2] * (1 - s) + (1 - 1 * (1 - s)),
                (l = e.Color.fromHsl(i[0], i[1], i[2])).toString().substring(1)) : r
            }
            ,
            s._parseColor = function(t) {
                var s = new e.Color(t);
                return s.a < 1 && (s = e.Color.toOpaque(s)),
                s.toString()
            }
            ,
            s._getsBaseSharedFormulas = function(e) {
                var t, s, l, i = e.match(/\<f[^<]*ref[^<]*>[^<]+(?=\<\/f>)/g);
                if (this._sharedFormulas = [],
                i && i.length > 0)
                    for (var r = 0; r < i.length; r++)
                        t = i[r],
                        s = this._getAttr(t, "si"),
                        l = (l = this._getAttr(t, "ref")) ? l.substring(0, l.indexOf(":")) : "",
                        t = t.replace(/(\<f.*>)(.+)/, "$2"),
                        this._sharedFormulas[+s] = this._parseSharedFormulaInfo(l, t)
            }
            ,
            s._parseSharedFormulaInfo = function(e, s) {
                var l, i, r, n, o, a = s.match(/(\'?\w+\'?\!)?(\$?[A-Za-z]+)(\$?\d+)/g);
                if (n = t.Workbook.tableAddress(e),
                a && a.length > 0) {
                    o = [];
                    for (var h = 0; h < a.length; h++)
                        l = a[h],
                        s = s.replace(l, "{" + h + "}"),
                        (i = l.indexOf("!")) > 0 && (r = l.substring(0, i),
                        l = l.substring(i + 1)),
                        o[h] = {
            ...
            s._getSharedFormula = function(e, s) {
                ...
                if (this._sharedFormulas && this._sharedFormulas.length > 0 && (l = this._sharedFormulas[+e])) {
                    if (c = l.formula,
                    (f = l.formulaRefs) && f.length > 0) {
                        i = t.Workbook.tableAddress(s),
                        h = l.cellRef ? l.cellRef.row : 0,
                        u = l.cellRef ? l.cellRef.col : 0,
                        r = i.row - h,
                        n = i.col - u;
                        for (var m = 0; m < f.length; m++)
                            o = (d = f[m]).cellAddress.row + (d.cellAddress.absRow ? 0 : r),
                            a = d.cellAddress.col + (d.cellAddress.absCol ? 0 : n),
                            p = t.Workbook.xlsxAddress(o, a, d.cellAddress.absRow, d.cellAddress.absCol),
                            null != d.sheetRef && "" !== d.sheetRef && (p = d.sheetRef + "!" + p),
                            c = c.replace("{" + m + "}", p)
                    }
                    return c
                }
            ...
            s._convertDate = function(t) {
                var s, l, i = new Date(1900,0,0), r = Date.UTC(1900, 0, 0), n = "[object Date]" === Object.prototype.toString.call(t), o = 6e4 * ((n ? t.getTimezoneOffset() : (new Date).getTimezoneOffset()) - i.getTimezoneOffset()), a = i.getTime() - r - 6e4 * i.getTimezoneOffset();
                return n ? (t.getTime() - i.getTime() - o + a) / 864e5 + 1 : e.isNumber(t) ? (s = t > 59 ? 1 : 0,
                l = new Date(1e3 * Math.round((+i + 864e5 * (t - s)) / 1e3)),
                0 !== (o = 6e4 * (l.getTimezoneOffset() - i.getTimezoneOffset())) ? new Date(1e3 * Math.round((+i + o - a + 864e5 * (t - s)) / 1e3)) : l) : null
            }
            ,
            s._parseBorder = function(s, l) {
                for (var i in {
                    ...
                    var r = s[i];
                    r && (e.isString(r.color) && (r.color = this._parseColor(r.color)),
                    null == r.style || e.isString(r.style) || (r.style = t.Workbook._parseBorderTypeToString(e.asEnum(r.style, t.BorderStyle, !1))),
                    !l && r.color && "#c6c6c6" === r.color.toLowerCase() && "thin" === r.style && (s[i] = null))
                }
            }
            ,
            ...
            s._cloneStyle = function(e) {
                ...
                t = {};
                for (var s in e)
                    e.hasOwnProperty(s) && (t[s] = this._cloneStyle(e[s]));
                return t
            }
            ,
            s._cloneColumnsStyle = function(e) {
                for (var t, s = [], l = 0; l < e.length; l++)
                    (t = e[l]) && t.style && (s[l] = this._cloneStyle(t.style));
                return s
            }
            ,
            s._getSheetIndex = function(e) {
                return e = e.substring(0, e.lastIndexOf(".xml")),
            ...
            s._getSheetIndexBySheetName = function(e, t) {
                for (var s = 0; s < e.sheets.length; s++)
                    if (e.sheets[s].name === t)
                        return s;
                return -1
            }
            ,
            s._alphabet = "ABCDEFGHIJKLMNOPQRSTUVWXYZ",
            s._indexedColors = ["000000", "FFFFFF", "FF0000", "00FF00", "0000FF", "FFFF00", "FF00FF", "00FFFF", "000000", "FFFFFF", "FF0000", "00FF00", "0000FF", "FFFF00", "FF00FF", "00FFFF", "800000", "008000", "000080", "808000", "800080", "008080", "C0C0C0", "808080", "9999FF", "993366", "FFFFCC", "CCFFFF", "660066", "FF8080", "0066CC", "CCCCFF", "000080", "FF00FF", "FFFF00", "00FFFF", "800080", "800000", "008080", "0000FF", "00CCFF", "CCFFFF", "CCFFCC", "FFFF99", "99CCFF", "FF99CC", "CC99FF", "FFCC99", "3366FF", "33CCCC", "99CC00", "FFCC00", "FF9900", "FF6600", "666699", "969696", "003366", "339966", "003300", "333300", "993300", "993366", "333399", "333333", "000000", "FFFFFF"],
            s._numFmts = ["General", "0", "0.00", "#,##0", "#,##0.00", , , "$#,##0.00_);($#,##0.00)", , "0%", "0.00%", "0.00E+00", "# ?/?", "# ??/??", "m/d/yyyy", "d-mmm-yy", "d-mmm", "mmm-yy", "h:mm AM/PM", "h:mm:ss AM/PM", "h:mm", "h:mm:ss", "m/d/yy h:mm", , , , , , , , , , , , , , , "#,##0 ;(#,##0)", "#,##0 ;[Red](#,##0)", "#,##0.00;(#,##0.00)", "#,##0.00;[Red](#,##0.00)", , , , , "mm:ss", "[h]:mm:ss", "mmss.0", "##0.0E+0", "@"],
            s._tableColumnFunctions = "average, count, countNums, max, min, stdDev, sum, var",
            s._xmlDescription = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>',
            s._workbookNS = "http://schemas.openxmlformats.org/spreadsheetml/2006/main",
            s._relationshipsNS = "http://schemas.openxmlformats.org/package/2006/relationships",
            s._defaultFontName = "Calibri",
            s._defaultFontSize = 11,
            s._macroEnabled = !1,
            s._defaultColorThemes = ["FFFFFF", "000000", "EEECE1", "1F497D", "4F818D", "C0504D", "9BBB59", "8064A2", "4BACC6", "F79646"],
            s
        }();
        t._xlsx = s;
        var l = function() {
          ...
          , i = function() {
            ...
            e.prototype.async = function() {
                for (var e = [], t = 0; t < arguments.length; t++)
                    e[t] = arguments[t];
                var s;
                return s = e && e.length > 0 && "uint8array" === e[0].toLowerCase() ? this._obj.asUint8Array() : this._obj.asText(),
                new l(s)
            }
            ,
            ...
            e.prototype.forEach = function(t) {
                var s = this._obj.root
                  ...
                  , i = this._obj.files;
                for (var r in i)
                    r.length > l && r.substr(0, l).toLowerCase() === s && t(r.substr(l), new e(i[r]))
            }
            ,
...
var __extends = this && this.__extends || function() {
    ...
    return function(t, s) {
        ...
        e(t, s),
        t.prototype = null === s ? Object.create(s) : (l.prototype = s.prototype,
        new l)
    }
}(), wijmo;
!function(e) {
    !function(t) {
        ...
        var s = function() {
            ...
            return Object.defineProperty(s.prototype, "sheets", {
                get: function() {
                    return null == this._sheets && (this._sheets = []),
                    this._sheets
                },
                enumerable: !0,
                configurable: !0
            ...
            Object.defineProperty(s.prototype, "styles", {
                get: function() {
                    return null == this._styles && (this._styles = []),
                    this._styles
                },
                enumerable: !0,
                configurable: !0
            ...
            Object.defineProperty(s.prototype, "definedNames", {
                get: function() {
                    return null == this._definedNames && (this._definedNames = []),
                    this._definedNames
                },
                enumerable: !0,
                configurable: !0
            ...
            Object.defineProperty(s.prototype, "reservedContent", {
                get: function() {
                    return null == this._reservedContent && (this._reservedContent = {}),
            ...
            s.prototype.save = function(e) {
                ...
                return e && s._saveToFile(l.base64, e, i),
                l.base64
            }
            ,
            ...
            s.prototype._serialize = function() {
                ...
                return e.sheets = this._serializeWorkSheets(),
            ...
            s._saveToFile = function(e, t, l) {
                var i, r, n, o, a, h, u = window.document, c = l ? "xlsm" : "xlsx", f = "xlsm" === c ? "application/vnd.ms-excel.sheet.macroEnabled.12" : "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                ...
                navigator.msSaveBlob ? navigator.msSaveBlob(n, t) : URL.createObjectURL ? (a = u.createElement("a"),
                h = function(e) {
            ...
            s.prototype._getBase64String = function(e) {
                ...
                return -1 !== (t = e.search(/base64,/i)) && (e = e.substring(t + 7)),
                e
            }
            ,
            s.toXlsxDateFormat = function(t) {
                ...
                return s || (s = t),
                s = s.replace(/"/g, "").replace(/tt/, "AM/PM").replace(/t/, "A/P").replace(/M+/gi, function(e) {
            ...
            s.toXlsxNumberFormat = function(t) {
                var s, l, i, r, n, o, a, h = -1, u = t ? t.toLowerCase() : "", c = [];
                if (/^[ncpfdg]\d*.*,*$/.test(u) && (s = u[0],
                l = this._formatMap[s]),
                l) {
                    if (r = u.split(","),
                    "c" === s && ("​" === (i = (a = t ? t.match(/([a-z])(\d*)(,*)(.*)/i) : null) && a[4] ? a[4] : e.culture.Globalize.numberFormat.currency.symbol) && (i = ""),
                    l = l.replace(/\{1\}/g, i)),
                    u.length > 1 ? h = parseInt(r[0].substr(1)) : "d" !== s && (h = 2),
                    !isNaN(h))
                        for (o = 0; o < h; o++)
                            c.push(0);
            ...
            s.fromXlsxFormat = function(t) {
                var s, l, i, r, n, o, a, h, u, c = [], f = e.culture.Globalize.numberFormat.currency.symbol;
                if (!t || "General" === t)
                    return [""];
                for (l = (t = t.replace(/;@/g, "").replace(/&quot;?/g, "")).split(";"),
                r = 0; r < l.length; r++) {
                    if (i = l[r],
                    /[hsmy\:]/i.test(i))
                        s = i.replace(/\[\$\-.+\]/g, "").replace(/(\\)(.)/g, "$2").replace(/H+/g, function(e) {
                            return e.toLowerCase()
                    ...
                    else if (o = i.lastIndexOf("."),
                    a = i.lastIndexOf("0"),
                    h = i.lastIndexOf(","),
                    s = i.search(/\[\$([^\-\]]+)[^\]]*\]/) > -1 || i.indexOf(f) > -1 && -1 === i.search(/\[\$([\-\]]+)[^\]]*\]/) ? "c" : "%" === i[t.length - 1] ? "p" : "n",
                    s += o > -1 && o < a ? i.substring(o, a).length : "0",
                    /^0+,*$/.test(i) && (s = "d" + ((a = i.lastIndexOf("0")) + 1)),
                    h > -1 && a > -1 && a < h)
                        for (u = i.substring(a + 1, h + 1).split(""),
                        n = 0; n < u.length; n++)
                            s += ",";
                    c.push(s)
                }
            ...
            ,
            s.xlsxAddress = function(e, t, s, l, i) {
                var r = s ? "$" : ""
                  , n = null == l ? r : l ? "$" : "";
                return !0 === i ? "" : (isNaN(t) ? "" : n + this._numAlpha(t)) + (!1 === i ? "" : isNaN(e) ? "" : r + (e + 1).toString())
            }
            ,
            s.tableAddress = function(e) {
                var t = /^((\$?)([A-Za-z]+))?((\$?)(\d+))?$/
                  , s = e && t.exec(e)
                  , l = {};
                return s ? (s[3] && (l.col = this._alphaNum(s[3]),
                l.absCol = !!s[2]),
                s[6] && (l.row = +s[6] - 1,
                l.absRow = !!s[5]),
                l) : null
            ...
            s._base64DecToArr = function(e, t) {
                for (var s, l, i = e.replace(/[^A-Za-z0-9\+\/]/g, ""), r = i.length, n = t ? Math.ceil((3 * r + 1 >> 2) / t) * t : 3 * r + 1 >> 2, o = new Uint8Array(n), a = 0, h = 0, u = 0; u < r; u++)
                    if (l = 3 & u,
                    a |= this._b64ToUint6(i.charCodeAt(u)) << 18 - 6 * l,
                    3 === l || r - u == 1) {
                        for (s = 0; s < 3 && h < n; s++,
                        h++)
                            o[h] = a >>> (16 >>> s & 24) & 255;
            ...
            s._base64EncArr = function(e) {
                for (var t = 2, s = "", l = e.length, i = 0, r = 0; r < l; r++)
                    t = r % 3,
                    r > 0 && 4 * r / 3 % 76 == 0 && (s += "\r\n"),
                    i |= e[r] << (16 >>> t & 24),
                    2 !== t && e.length - r != 1 || (s += String.fromCharCode(this._uint6ToB64(i >>> 18 & 63), this._uint6ToB64(i >>> 12 & 63), this._uint6ToB64(i >>> 6 & 63), this._uint6ToB64(63 & i)),
                    i = 0);
            ...
            s.prototype._serializeWorkSheets = function() {
                ...
                for (t = 0; t < this._sheets.length; t++)
                    (e = this._sheets[t]) && (s[t] = e._serialize());
                return s
            }
            ,
            s.prototype._serializeWorkbookStyles = function() {
                ...
                for (t = 0; t < this._styles.length; t++)
                    (e = this._styles[t]) && (s[t] = e._serialize());
                return s
            }
            ,
            s.prototype._serializeDefinedNames = function() {
                ...
                for (t = 0; t < this._definedNames.length; t++)
                    (e = this._definedNames[t]) && (s[t] = e._serialize());
                return s
            }
            ,
            s.prototype._serializeTableStyles = function() {
                var e, t, s = [];
                for (t = 0; t < this._tableStyles.length; t++)
                    (e = this._tableStyles[t]) && (s[t] = e._serialize());
                return s
            }
            ,
            s.prototype._deserializeWorkSheets = function(t) {
                var s, i, r;
                for (this._sheets = [],
                e.assert(null != t, "workSheets should not be null."),
                r = 0; r < t.length; r++)
                    (i = t[r]) && ((s = new l)._deserialize(i),
                    this._sheets[r] = s)
            }
            ,
            s.prototype._deserializeWorkbookStyles = function(e) {
                ...
                for (this._styles = [],
                l = 0; l < e.length; l++)
                    (s = e[l]) && ((t = new a)._deserialize(s),
                    this._styles[l] = t)
            }
            ,
            s.prototype._deserializeDefinedNames = function(e) {
                var t, s, l;
                for (this._definedNames = [],
                l = 0; l < e.length; l++)
                    (s = e[l]) && ((t = new d)._deserialize(s),
                    this._definedNames[l] = t)
            }
            ,
            s.prototype._deserializeTableStyles = function(e) {
                var t, s, l;
                for (this._tableStyles = [],
                l = 0; l < e.length; l++)
                    (s = e[l]) && ((t = new g)._deserialize(s),
                    this._tableStyles[l] = t)
            }
            ,
            s._alphabet = "ABCDEFGHIJKLMNOPQRSTUVWXYZ",
        ...
        var l = function() {
            ...
            return Object.defineProperty(e.prototype, "columns", {
                get: function() {
                    return null == this._columns && (this._columns = []),
                    this._columns
                },
                enumerable: !0,
                configurable: !0
            ...
            Object.defineProperty(e.prototype, "rows", {
                get: function() {
                    return null == this._rows && (this._rows = []),
                    this._rows
                },
                enumerable: !0,
                configurable: !0
            ...
            Object.defineProperty(e.prototype, "tables", {
                get: function() {
                    return null == this._tables && (this._tables = []),
                    this._tables
                },
                enumerable: !0,
                configurable: !0
            ...
            e.prototype._serialize = function() {
                var e;
                return this._checkEmptyWorkSheet() ? null : (e = {},
            ...
            e.prototype._deserialize = function(e) {
                var t, s;
                e.style && ((s = new a)._deserialize(e.style),
                this.style = s),
                ...
                e.frozenPane && ((t = new o)._deserialize(e.frozenPane),
                this.frozenPane = t),
                this.name = e.name,
            ...
            e.prototype._serializeWorkbookColumns = function() {
                ...
                for (t = 0; t < this._columns.length; t++)
                    (e = this._columns[t]) && (s[t] = e._serialize());
                return s
            }
            ,
            e.prototype._serializeWorkbookRows = function() {
                ...
                for (t = 0; t < this._rows.length; t++)
                    (e = this._rows[t]) && (s[t] = e._serialize());
                return s
            }
            ,
            e.prototype._serializeTables = function() {
                ...
                for (t = 0; t < this._tables.length; t++)
                    (e = this._tables[t]) && (s[t] = e._serialize());
                return s
            }
            ,
        ...
        var i = function() {
            ...
            return e.prototype._serialize = function() {
                var e;
                return this._checkEmptyWorkbookColumn() ? null : (e = {},
                this.style && (e.style = this.style._serialize()),
            ...
            e.prototype._deserialize = function(e) {
                var t;
                e.style && ((t = new a)._deserialize(e.style),
                this.style = t),
        ...
        var r = function() {
            ...
            return Object.defineProperty(e.prototype, "cells", {
                get: function() {
                    return null == this._cells && (this._cells = []),
                    this._cells
                },
                enumerable: !0,
                configurable: !0
            ...
            e.prototype._serialize = function() {
                var e;
                return this._checkEmptyWorkbookRow() ? null : (e = {},
            ...
            e.prototype._serializeWorkbookCells = function() {
                ...
                for (t = 0; t < this._cells.length; t++)
                    (e = this._cells[t]) && (s[t] = e._serialize());
                return s
            }
            ,
        ...
        var n = function() {
            ...
            return e.prototype._serialize = function() {
                var e;
                return this._checkEmptyWorkbookCell() ? null : (e = {},
                this.style && (e.style = this.style._serialize()),
                ...
                this.textRuns && this.textRuns.length > 0 && (e.textRuns = this._serializeTextRuns()),
                e)
            }
            ,
            e.prototype._deserialize = function(e) {
                ...
                this.link = e.link,
                e.textRuns && e.textRuns.length > 0 && this._deserializeTextRuns(e.textRuns)
            }
            ,
        ...
        var a = function() {
            ...
            return t.prototype._serialize = function() {
                var t;
                return this._checkEmptyWorkbookStyle() ? null : (t = {},
                this.basedOn && (t.basedOn = this.basedOn._serialize()),
                this.fill && (t.fill = this.fill._serialize()),
                this.font && (t.font = this.font._serialize()),
                this.borders && (t.borders = this.borders._serialize()),
                this.format && (t.format = this.format),
                null != this.hAlign && (t.hAlign = e.asEnum(this.hAlign, S, !1)),
                null != this.vAlign && (t.vAlign = e.asEnum(this.vAlign, w, !1)),
                null == this.indent || isNaN(this.indent) || (t.indent = this.indent),
                this.wordWrap && (t.wordWrap = this.wordWrap),
                t)
            }
            ,
            t.prototype._deserialize = function(s) {
                var l, i, r, n;
                s.basedOn && ((l = new t)._deserialize(s.basedOn),
                this.basedOn = l),
                s.fill && ((i = new u)._deserialize(s.fill),
                this.fill = i),
                s.font && ((r = new h)._deserialize(s.font),
                this.font = r),
                s.borders && ((n = new c)._deserialize(s.borders),
                this.borders = n),
                this.format = s.format,
                null != s.hAlign && (this.hAlign = e.asEnum(s.hAlign, S, !1)),
                null != s.vAlign && (this.vAlign = e.asEnum(s.vAlign, w, !1)),
                null == s.indent || isNaN(s.indent) || (this.indent = s.indent),
                s.wordWrap && (this.wordWrap = s.wordWrap)
            }
            ,
        ...
        var h = function() {
            ...
            return e.prototype._serialize = function() {
                var e;
                return this._checkEmptyWorkbookFont() ? null : (e = {},
        ...
        var c = function() {
            ...
            return e.prototype._serialize = function() {
                var e;
                return this._checkEmptyWorkbookBorder() ? null : (e = {},
            ...
            e.prototype._deserialize = function(e) {
                var t, s, l, i, r;
                e.top && ((t = new f)._deserialize(e.top),
                this.top = t),
                e.bottom && ((s = new f)._deserialize(e.bottom),
                this.bottom = s),
                e.left && ((l = new f)._deserialize(e.left),
                this.left = l),
                e.right && ((i = new f)._deserialize(e.right),
                this.right = i),
                e.diagonal && ((r = new f)._deserialize(e.diagonal),
                this.diagonal = r)
            }
            ,
        ...
        var f = function() {
            ...
            return t.prototype._serialize = function() {
                var t;
                return null != this.color && "" !== this.color || null != this.style ? (t = {},
                this.color && (t.color = this.color),
                null != this.style && (t.style = e.asEnum(this.style, x, !1)),
                t) : null
            }
            ,
            t.prototype._deserialize = function(t) {
                null != t.color && (this.color = t.color,
                null != t.style && (this.style = e.asEnum(t.style, x, !1)))
            }
            ,
            t
        }();
        ...
        var p = function() {
            ...
            t.prototype._serialize = function() {
                var e, t;
                return null == this.name || null == this.range || null == this._columns ? null : (null != this.style && (t = this.style._serialize()),
                e = {
                    name: this.name,
                    range: this.range,
            ...
            t.prototype._deserialize = function(e) {
                ...
                null != e.style && ((t = new g)._deserialize(e.style),
                this.style = t),
            ...
            t.prototype._deserializeTableColumns = function(t) {
                var s, l, i;
                for (e.assert(null != t, "table Columns should not be null."),
                this._columns = [],
                i = 0; i < t.length; i++)
                    (l = t[i]) && ((s = new m)._deserialize(l),
                    this._columns[i] = s)
            }
            ,
            t
        ...
        var _ = function(e) {
            ...
            t.prototype._deserialize = function(t) {
                ...
                t.borders && ((s = new b)._deserialize(t.borders),
                this.borders = s)
            }
            ,
            t
        ...
        var y = function(e) {
            ...
            t.prototype._serialize = function() {
                var t;
                return t = e.prototype._serialize.call(this),
                t.size = this.size,
                t
            }
            ,
        ...
        var b = function(e) {
            ...
            t.prototype._serialize = function() {
                var t;
                return null != (t = e.prototype._serialize.call(this)) || this.vertical && this.horizontal || (t = {}),
            ...
            t.prototype._deserialize = function(t) {
                var s, l;
                e.prototype._deserialize.call(this, t),
                t.vertical && ((s = new f)._deserialize(t.vertical),
                this.vertical = s),
                t.horizontal && ((l = new f)._deserialize(t.horizontal),
                this.horizontal = l)
            }
            ,
            t
        ...
        var v = function() {
            ...
            return e.prototype._serialize = function() {
                ...
                return this.font && (e.font = this.font._serialize()),
                e
            }
            ,
            e.prototype._deserialize = function(e) {
                e.font && (this.font = new h,
