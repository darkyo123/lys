...
<script>
	...
	var flexColumns = [
    	...
    	{ header: '이름', binding: 'userNm', width: '1*', isReadOnly: true },
    	{ header: 'ID', binding: 'userId', width: '1*', isReadOnly: true },
    	{ header: '권한코드', binding: 'authorCd', width: '1*', isReadOnly: true },
    	{ header: '권한', binding: 'authorNm', width: '1*', isReadOnly: true },
    	{ header: '등록일자', binding: 'registDe', width: '1*', isReadOnly: true },
    	{ header: '계정잠금여부', binding: 'lockAt', width: '1*', isReadOnly: true },
