	...
	function updateData() {
		...
		if("" == usrId) {
			...
			if(!validateQslt()) {
				...
				$.post('/whms/hi/qsltRegistPopupAjax.do', $frm.serialize(), function(r){
					if(r && r.success) {
						alert("정상적으로 등록되었습니다.");
...
<form name="selectOne">
	...
	<div id="subcontainer">
		<div class="swrap">
			<div class="subcont">
				<div class="right_area p25" style="width: 1200px;">
					<form id="detailForm" name="detailForm" action="<c:url value='/whms/hi/qsltList.do'/>" method="post">
						...
						<input name="SysRgsDt" type="hidden" value="<c:out value='${detailVO.sysRgsDt}'/>" />
							<c:if test="${empty param.targetDt }">
									...
									<div class="search_tb mb0">
									 ...
									 <div class="stb_right">
									  ...
									  <!-- <button type="button" class="btn-type btn_ico gray_line" onClick="deleteData()"><span class="i_del_bg">삭제</span></button> -->
									  	<button type="button" class="btn-type btn_ico gray_line" onClick="updateData()"><span class="i_mwrite_bg">추가</span></button>
									 </div>
									</div>
									<!-- // search_tb -->
								</div>
							...
							<div class="reg_form">          
							  <ul>
							    ...
							    <label for="Havdis8Yn" class="highDgrColor" >고혈압(약 미복용)</label>
							    ...
							    <label for="Havdis3Yn" class="highDgrColor">고지혈증</label>
							    ...
							    <label for="Havdis4Yn" class="highDgrColor">천식</label>
							  ...
							  <ul>
							    ...
							    <label for="Repsym1Yn" class="highDgrColor">호흡곤란이 있다.</label>
							    ...
							    <label for="Repsym4Yn" class="highDgrColor">천식이 있다.</label>
							    ...
							    <label for="Cirsym1Yn" class="highDgrColor">머리가 자주 아프다.</label>
							...
							<c:if test="${empty param.targetDt }">
								...
								<div class="search_tb mb0">
								 ...
								 <div class="stb_right">
								  <!-- <button type="button" class="btn-type btn_ico gray_line" onClick=""><span class="i_del_bg">등록</span></button> -->
								  <!-- <button type="button" class="btn-type btn_ico gray_line" onClick="deleteData()"><span class="i_write_bg">삭제</span></button> -->
								  <button type="button" class="btn-type btn_ico gray_line" onClick="updateData()"><span class="i_mwrite_bg">추가</span></button>
								 </div>
								</div>
								<!-- // search_tb -->
