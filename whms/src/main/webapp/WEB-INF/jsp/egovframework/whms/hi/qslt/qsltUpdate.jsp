...
<script>
	function fnList() {
		document.updateForm.action="/whms/qsltList.do";
		document.updateForm.submit();
	}
	function fnUpdate() {
		if(confirm("수정하시겠습니까?")) {
			document.updateForm.action="/whms/qsltUpdate.do";
			document.updateForm.submit();
		}
	}
</script>
...
<body>
	<form name="updateForm" action="<c:url value='/whms/qsltList.do'/>" method="post">
