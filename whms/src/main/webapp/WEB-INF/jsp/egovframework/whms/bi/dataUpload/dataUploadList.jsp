...
<script>
	...
	/** 건강진단 grid 컬럼 */
	var healthColumns = [
    	{ header: '검진종류', binding: 'meckuNm', isReadOnly: true, width: '1*' },
    	{ header: '재검 여부', binding: 'rtychkYn',  isReadOnly: true, width: 80 },
    	{ header: '유해인자', binding: 'harmNm',  isReadOnly: true, width: '1*' },
	    { header: '진단일자', binding: 'diagDt',  isReadOnly: true, width: 100 },
    	{ header: 'ID', binding: 'usrId',  isReadOnly: true, width: '1*' },
    	...
    	{ header: '진단기관', binding: 'diagInstNm',  isReadOnly: true, width: '1*' },
    	{ header: '차회 검진 기한', binding: 'nxtdDt',  isReadOnly: true, width: 100 },
    	{ header: '검진결과', binding: 'merstRmk', isReadOnly: true, width: '1*' },
    	{ header: '유소견 이력', binding: 'dcviwHisNm',  isReadOnly: true, width: '1*' },
    	{ header: '유소견 관리 내용', binding: 'dcviwCtlRmk',  isReadOnly: true, width: '1*' },
    	{ header: '뇌심혈관계 평가 포함 여부', binding: 'brdevlYn', width: 160,  isReadOnly: true }
    ];
	/** 교육 grid 컬럼 */
	var eduColumns = [
    	{ header: '교육일자', binding: 'eduDt', isReadOnly: true, width: 100 },
    	{ header: '교육 종류', binding: 'eduKindNm',  isReadOnly: true, width: '1*' },
    	{ header: '교육명', binding: 'eduNm',  isReadOnly: true, width: '1*' },
	    /* { header: '업체명', binding: 'begNm',  isReadOnly: true }, */
    	{ header: 'ID', binding: 'usrId',  isReadOnly: true, width: '1*' },
    	/* { header: '성명', binding: 'usrNm',  isReadOnly: true, width: 80 }, */
    	/* { header: '성별', binding: 'sexSecd',  isReadOnly: true, width: 60 }, */
    	/* { header: '나이', binding: 'usrAge',  isReadOnly: true, width: 60 }, */
    	{ header: '교육기간', binding: 'eduDy',  isReadOnly: true, width: '1*' },
    	{ header: '교육 시작', binding: 'eduStrDt',  isReadOnly: true, width: '1*' },
    	{ header: '교육 종료', binding: 'eduEndDt',  isReadOnly: true, width: '1*' },
    	{ header: '이수 여부', binding: 'eduCptYn', isReadOnly: true, width: 80 },
    	{ header: '교육강사', binding: 'eduTechNm',  isReadOnly: true, width: 80 },
    	{ header: '교육강사 자격', binding: 'eduTechQual',  isReadOnly: true, width: '1*' }
    ];
	...
	onload = function() {
		...
		if(flexColumns == null) flexColumns = healthColumns;
							...
							<div class="stb_left">
								<span class="select w100p">
									<select name="searchCondition" >
									  ...
									  <option value="H" selected>건강진단</option>
