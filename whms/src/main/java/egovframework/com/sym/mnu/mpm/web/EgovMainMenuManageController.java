...
public class EgovMainMenuManageController {
    ...
    public String selectMainMenu(
    	...
    	menuManageVO.setTmpPassword(user.getUsrPwd());
...
//    	menuManageVO.setTmpUniqId(user.getUniqId());
    	...
    	MenuManageVO topMenuNm = menuManageService.selectLastMenuNm(iMenuNo, user.getId(), "dir");
    	model.addAttribute("menu_nm", topMenuNm);
		if (!user.getId().equals("")) {
        	// 메인 페이지 이동
...
//        model.addAttribute("list_menulist", list_menulist);
    ...
    public String selectMainMenuRight(
    	...
    	if(request.getParameter("chkURL") != null) {
    		chkURL = request.getParameter("chkURL");
    	}

    	menuManageVO.setTmpId(user.getId());
    	List<?> list_menulist = menuManageService.selectMainMenuLeft(menuManageVO);
        request.setAttribute("menuList", list_menulist);

    	String forwardURL = null;
    	forwardURL = menuManageService.selectLastMenuURL(iMenuNo, user.getId(), chkURL);
