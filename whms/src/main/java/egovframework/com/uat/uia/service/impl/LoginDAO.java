...
public class LoginDAO extends EgovComAbstractDAO {
    ...
    public String checkOtp(LoginVO loginVO) throws Exception {
    	return selectOne("LoginUsr.checkOtp", loginVO);
    }

    public void updateOtp(EgovMap map) throws Exception {
    	update("LoginUsr.updateOtp", map);
    }

    public LoginVO selectLockInfo(LoginVO vo) throws Exception {
    	return (LoginVO)selectOne("LoginUsr.selectLockInfo", vo);
    }

    public void updateLoginFail(LoginVO vo) throws Exception {
    	update("LoginUsr.updateLoginFail", vo);
    }

    public void insertLockHist(LoginVO vo) throws Exception {
    	insert("LoginUsr.insertLockHist", vo);
    }   
