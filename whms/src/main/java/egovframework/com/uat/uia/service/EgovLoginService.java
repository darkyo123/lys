...
public interface EgovLoginService {
    ...
    EgovMap getOtpKey(LoginVO loginVO) throws Exception;

    boolean checkOtpKey(String otpKey, String otpVal) throws Exception;

    void updateLoginFail(LoginVO loginVO) throws Exception;
