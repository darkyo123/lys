...
public class EgovMenuManageServiceImpl extends EgovAbstractServiceImpl implements EgovMenuManageService {
	...
	/**
	 * MainMenu Head Menu Nm 조회
	 * @param  iMenuNo  int
	 * @param  sUniqId  String
	 * @return String
	 * @exception Exception
	 */
	public MenuManageVO selectLastMenuNm(int iMenuNo, String sUniqId, String chkURL) throws Exception {
		MenuManageVO vo = new MenuManageVO();
		vo.setMenuNo(selectLastMenuNo(iMenuNo, sUniqId, chkURL));
		return menuManageDAO.selectLastMenuNm(vo);
	}
	 ...
	 * @exception Exception
	 */
	public String selectLastMenuURL(int iMenuNo, String sUniqId, String chkURL) throws Exception {
		MenuManageVO vo = new MenuManageVO();
		vo.setMenuNo(selectLastMenuNo(iMenuNo, sUniqId, chkURL));
	 ...
	 * @exception Exception
	 */
	private int selectLastMenuNo(int iMenuNo, String sUniqId, String chkURL) throws Exception {
