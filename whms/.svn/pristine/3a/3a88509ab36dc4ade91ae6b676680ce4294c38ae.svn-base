...
public class ConsultHistoryVO {
	...
	private List<ConsultHistoryVO> detailList;

	private String searchCondition;
	private String searchKeyword;
	private String paramGrpCd;
	...
	private String fahsCalcVal;
	private String usrHet;
	private String usrWet;
	private String alcYn;
	private String bmiCt;
	private String mecku1Yn;
	private String mecku2Yn;
	private String mecku3Yn;
	private String mecku4Yn;
	private String mecku5Yn;
	private String mecku6Yn;
	private String hypctCt;
	private String hyprxCt;
	private String plsCt;
	private String lstChkDt;
	...
	private String highDgrCdInfo;
	private String updId;
	private String sysRgsDt;
	private String pressureFlag;
	private String dcviwYn;
	private String highDgrNm;
	private String begCd;
	private String entryDt;
	private String totCnt;
	private String listDt;
	private String bigo;
	private String qsltYn;
	private String loginId;
	private String dcviwDt;
	private String dcviwDesc;

	private String maxHypctCt;
	private String maxHyprxCt;
	private String maxPlsCt;
	...
	public String getAcrRutnYn() {
		return acrRutnYn;
	}
	public void setAcrRutnYn(String acrRutnYn) {
		this.acrRutnYn = acrRutnYn;
	}
	...
	public String getBmiCt() {
		return bmiCt;
	}
	public void setBmiCt(String bmiCt) {
		this.bmiCt = bmiCt;
	}
	public String getMecku1Yn() {
		return mecku1Yn;
	}
	public void setMecku1Yn(String mecku1Yn) {
		this.mecku1Yn = mecku1Yn;
	}
	public String getMecku2Yn() {
		return mecku2Yn;
	}
	public void setMecku2Yn(String mecku2Yn) {
		this.mecku2Yn = mecku2Yn;
	}
	public String getMecku3Yn() {
		return mecku3Yn;
	}
	public void setMecku3Yn(String mecku3Yn) {
		this.mecku3Yn = mecku3Yn;
	}
	public String getHypctCt() {
		return hypctCt;
	}
	public void setHypctCt(String hypctCt) {
		this.hypctCt = hypctCt;
	}
	public String getHyprxCt() {
		return hyprxCt;
	}
	public void setHyprxCt(String hyprxCt) {
		this.hyprxCt = hyprxCt;
	}
	public String getPlsCt() {
		return plsCt;
	}
	public void setPlsCt(String plsCt) {
		this.plsCt = plsCt;
	}
	public String getLstChkDt() {
		return lstChkDt;
	}
	public void setLstChkDt(String lstChkDt) {
	...
	public String getFahsCalcVal() {
		return fahsCalcVal;
	}
	public void setFahsCalcVal(String fahsCalcVal) {
		this.fahsCalcVal = fahsCalcVal;
	}
	...
	public void setHavdis8Yn(String havdis8Yn) {
		this.havdis8Yn = havdis8Yn;
	}
	public String getMecku6Yn() {
		return mecku6Yn;
	}
	public void setMecku6Yn(String mecku6Yn) {
		this.mecku6Yn = mecku6Yn;
	}
	...
	public String getHighDgrNm() {
		return highDgrNm;
	}
	public void setHighDgrNm(String highDgrNm) {
		this.highDgrNm = highDgrNm;
	}
	public String getBegCd() {
		return begCd;
	}
	public void setBegCd(String begCd) {
		this.begCd = begCd;
	}
	...
	public List<ConsultHistoryVO> getDetailList() {
		return detailList;
	}
	public void setDetailList(List<ConsultHistoryVO> detailList) {
	...
	public String getQsltYn() {
		return qsltYn;
	}
	public void setQsltYn(String qsltYn) {
		this.qsltYn = qsltYn;
	}
	...
	public String getDcviwDt() {
		return dcviwDt;
	}
	public void setDcviwDt(String dcviwDt) {
		this.dcviwDt = dcviwDt;
	}
	public String getDcviwDesc() {
		return dcviwDesc;
	}
	public void setDcviwDesc(String dcviwDesc) {
		this.dcviwDesc = dcviwDesc;
	}
	public String getHighDgrCdInfo() {
		return highDgrCdInfo;
	}
	public void setHighDgrCdInfo(String highDgrCdInfo) {
		this.highDgrCdInfo = highDgrCdInfo;
	}
	public String getMaxHypctCt() {
		return maxHypctCt;
	}
	public void setMaxHypctCt(String maxHypctCt) {
		this.maxHypctCt = maxHypctCt;
	}
	public String getMaxHyprxCt() {
		return maxHyprxCt;
	}
	public void setMaxHyprxCt(String maxHyprxCt) {
		this.maxHyprxCt = maxHyprxCt;
	}
	public String getMaxPlsCt() {
		return maxPlsCt;
	}
	public void setMaxPlsCt(String maxPlsCt) {
		this.maxPlsCt = maxPlsCt;
	}
