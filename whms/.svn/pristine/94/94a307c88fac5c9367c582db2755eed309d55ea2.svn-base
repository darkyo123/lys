...
public interface EgovMenuManageService {
	 ...
	 * @exception Exception
	 */
	MenuManageVO selectLastMenuNm(int iMenuNo, String sUniqId, String chkURL) throws Exception;
	 ...
	 * @exception Exception
	 */
	String selectLastMenuURL(int iMenuNo, String sUniqId, String chkURL) throws Exception;
