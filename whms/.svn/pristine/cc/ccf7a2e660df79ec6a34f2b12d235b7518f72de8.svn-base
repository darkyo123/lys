...
public class EgovStringUtil {
	...
	public static String wijmoTagRemove(String value) {
		value = value.replaceAll("&lt;span style=\"font-size: 12px;color: #333333;\"&gt;", "");
		value = value.replaceAll("&lt;span style=\"font-size: 12px;color: #000000;\"&gt;", "");
