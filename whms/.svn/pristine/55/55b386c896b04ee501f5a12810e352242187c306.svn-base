	...
	<div class="search_box">
		<ul>
			<li>
			   ...
			   <option value='1' <c:if test="${searchVO.searchList == '1'}">selected="selected"</c:if>><spring:message code="comSymCcmZip.zipVO.SearchAddr" /></option>  <!-- 주소 -->
		    ...
		    <input type="submit" class="s_btn" value="<spring:message code="button.create" />" onclick="fn_egov_regist_Zip(); return false;"> <!-- 등록 -->
		    <input type="submit" class="s_btn" value="<spring:message code="button.excel" /><spring:message code="button.create" />" onclick="fn_egov_regist_ExcelZip(); return false;">
		    </li>
	  	<ul>
	  </div>
