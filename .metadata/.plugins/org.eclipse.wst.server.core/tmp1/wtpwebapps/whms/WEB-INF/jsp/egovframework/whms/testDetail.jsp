...
<script>
	function fnList() {
		document.detailForm.action="/whms/testList.do";
		document.detailForm.submit();
	}
	function fnUpdate() {
		document.detailForm.action="/whms/testUpdate.do";
		document.detailForm.submit();
	}
	function fnDelete() {
		if(confirm("삭제하시겠습니까?")) {
			document.detailForm.action="/whms/testDelete.do";
			document.detailForm.submit();
		}
	}
</script>
...
<body>
	<form name="detailForm" action="<c:url value='/whms/testList.do'/>" method="post">
