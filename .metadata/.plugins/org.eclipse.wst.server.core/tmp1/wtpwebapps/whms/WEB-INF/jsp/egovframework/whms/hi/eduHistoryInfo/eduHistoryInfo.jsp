...
<script>
	...
	var flexColumns = [
    	...
    	{ header: '교육일자', binding: 'eduDt', width: 90, isReadOnly: true },
    	{ header: '교육종류', binding: 'eduKindNm', width: '1*', isReadOnly: true },
    	...
    	{ header: '성별', binding: 'sexSecd', width: 50, isReadOnly: true },
    	{ header: '나이', binding: 'usrAge', width: 60, isReadOnly: true },
    	{ header: '교육시간', binding: 'eduDy', width: '1*', isReadOnly: true },
    	{ header: '교육시작', binding: 'eduStrDt', width: '1*', isReadOnly: true },
    	{ header: '교육종료', binding: 'eduEndDt', width: '1*', isReadOnly: true },
    	{ header: '이수여부', binding: 'eduCptYn', width: 60, isReadOnly: true },
    	{ header: '교육강사', binding: 'eduTechNm', width: 100, isReadOnly: true },
    	{ header: '교육강사자격', binding: 'eduTechQual', width: '1*', isReadOnly: true }
    ];
