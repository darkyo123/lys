...
function actionLogin() {
	if (document.loginForm.id.value =="") {
    	...
    	if(otpChk == "N") {
    		...
    		var url = "<c:url value='/uat/uia/otpPopup.do' />";
    	    var popupwidth = '600';
    	    var popupheight = '560';
    	    var title = 'OTP 인증코드 입력';
...
$(document).ready(function() {
	...
	<c:if test="${not empty parentYn}">
	    if("${parentYn}" == "N") {
	    	...
	    	document.selectTop.action = "<c:url value='/uat/uia/egovLoginUsr.do'/>";
	    	document.selectTop.target = "_top";
	    	document.selectTop.submit();
	    }
    </c:if>
    /** wijmo modal 세팅 */
...
<div id="container">
  ...
  <!--// section_main -->
	...
	<div class="div_warning">
		...
		<p class="warning_main">본 시스템은 CJ그룹 협력사에 한하여 사용하실 수 있습니다. 불법적인 접근 및 사용 시 관련 법규에 의해 처벌될 수 있습니다. <a href="javascript:fn_show_secure()">[인트라넷 보안지침]</a></p>
